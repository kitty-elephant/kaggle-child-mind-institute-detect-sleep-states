...
def load_model(cfg: InferenceConfig) -> BaseModel:
    ...
    if cfg.weight is not None:
        weight_path = (
            Path(cfg.dir.model_dir) / cfg.weight.exp_name / cfg.weight.exp_name / cfg.weight.run_name / "best_model.pth"
        )
...
def main(cfg: InferenceConfig):
    ...
    sub_df.write_csv(Path(cfg.dir.sub_dir) / f"{cfg.weight.exp_name}_submission.csv")
